...
public class CreateUserPostCallWithPOJOTest {
    ...
    public void createUser() throws Exception, JsonProcessingException {
        ...
        User user = new User("shiva", "shiva70986586346test@gmail.com", "male", "active");
        ...
        APIResponse createUser = requestContext.post("https://gorest.co.in/public/v2/users",
            RequestOptions.create().setHeader("Content-Type", "application/json")
                .setHeader("Authorization", "Bearer 3cf580d1ec34eee42d1953c362d56dddefed1d42ecde8abc48fb8de0e0b9b6cb").setData(user));
