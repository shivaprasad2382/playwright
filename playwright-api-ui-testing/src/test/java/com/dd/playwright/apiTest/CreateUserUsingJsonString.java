...
public class CreateUserUsingJsonString {
    ...
    public void createUser() {
        String requestJson = "{\"id\": 8111781,\"name\": \"shivaprasad\",\"email\": \"shivatest17574871508272@gmail.com\",\"gender\": \"male\",\"status\": \"active\"}";
        APIResponse createUser = requestContext.post("https://gorest.co.in/public/v2/users",
            RequestOptions.create().setHeader("Content-Type", "application/json")
                .setHeader("Authorization", "Bearer 3cf580d1ec34eee42d1953c362d56dddefed1d42ecde8abc48fb8de0e0b9b6cb")
                .setData(requestJson));
